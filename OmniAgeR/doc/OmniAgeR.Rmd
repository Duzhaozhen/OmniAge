...
`OmniAgeR` includes a function to calculate the DNA methylation-based smoking index using 1,501 smoking-associated CpG sites. This score correlates with cancer risk across multiple tissues and provides a robust epigenetic signature of smoking exposure.
...
| `ABEC` | Chronological | `EpiAge()`,`ABEC()` |
| `eABEC` | Chronological | `EpiAge()`,`eABEC()` |
| `cABEC` | Chronological | `EpiAge()`,`cABEC()` |
| `PipekElasticNet` | Chronological | `EpiAge()`,`PipekElasticNet()` |
| `PipekFilteredh` | Chronological | `EpiAge()`,`PipekFilteredh()` |
| `PipekRetrainedh` | Chronological | `EpiAge()`,`PipekRetrainedh()` |
| `WuClock` | Chronological | `EpiAge()`,`WuClock()` |
