...
EpiCMIT <- function(data.m){
  ...
  print(paste("[EpiCMIT] Number of represented EpiCMIT_hyper CpGs (max=184)=",nhyper,sep=""))
  print(paste("[EpiCMIT] Number of represented EpiCMIT_hypo CpGs (max=1164)=",nhypo,sep=""))
