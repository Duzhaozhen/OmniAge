...
from .transcriptomic import scImmuAging,BrainCTClock,PASTA_Clock, ScAgePolyakClock, BuckleyMouseSVZ
...
from .dnam_mouse_clock import *
from .proteomic_clock import WyssCorayOrganAge,GladyshevOrganAge
